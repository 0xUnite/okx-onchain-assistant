...
<body>
    <div class="container">
        ...
        <div class="tabs">
            <div class="tab active" onclick="switchTab('portfolio')">钱包组合</div>
            <div class="tab" onclick="switchTab('market')">市场数据</div>
            <div class="tab" onclick="switchTab('swap')">DEX 闪兑</div>
            <div class="tab" onclick="switchTab('smart')">Smart Money</div>
